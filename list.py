...
if __name__ == "__main__" :
    ...
    Submit = Button(gui, text = "Done", fg = "white", bg = "Black", command = insertTask)
 
    # create a text area for the root
    # with Times New Roman font
    # text area is for writing the content
    TextArea = Text(gui, height = 7, width = 27, font = "Arial")
 
    # create a label : Delete Task Number
    taskNumber = Label(gui, text = "Delete Task Number", bg = "light pink")
                        
    taskNumberField = Text(gui, height = 1, width = 2, font = "Arial")
